...
//     <h1 className="text-2xl font-bold mb-4">Bảng giá dịch vụ</h1>
//     <p>Vui lòng xem chi tiết bảng giá trên trang chủ hoặc liên hệ để biết thêm thông tin.</p>
//   </div>
// );

// export default PricingPage;
import React from 'react';
import { ArrowRight, Bike, Building2, Car, ShieldCheck, Truck } from 'lucide-react';
import type { LucideIcon } from 'lucide-react';
import pricingHeroImage from '../../src/assets/images/xe.jpg';
...
const pricingPlans: PricingPlan[] = [
  {
    ...
    icon: Bike,
    prices: [
      { label: 'Theo lượt', value: '5.000đ' },
      { label: 'Qua đêm', value: '15.000đ' },
      { label: 'Theo tháng', value: '150.000đ' },
    ],
  ...
  },
  {
    ...
    featured: true,
    prices: [
      { label: 'Theo lượt', value: '25.000đ' },
      { label: 'Qua đêm', value: '80.000đ' },
      { label: 'Theo tháng', value: '1.200.000đ' },
    ],
    actionLabel: 'Đặt chỗ ngay',
  },
  {
    title: 'Xe tải và xe khách',
    subtitle: 'Dành cho xe tải nhẹ và xe dịch vụ',
    icon: Truck,
    prices: [
      { label: 'Theo lượt', value: '40.000đ' },
      { label: 'Qua đêm', value: '120.000đ' },
      { label: 'Theo tháng', value: '2.500.000đ' },
    ],
    actionLabel: 'Chọn gói này',
  },
];

export default function PricingPage({ setView }: { setView: (view: string) => void }) {
  return (
              ...
              return (
                ...
                >
                    ...
                    {plan.prices.map((price, index) => (
                      <div
                        ...
                        className={[
                          ...
                          index === plan.prices.length - 1 ? 'border-b-0 pb-0' : '',
                        ].join(' ')}
                      >
                  ...
                  <button
                    ...
                    className={[
                      'mt-8 flex w-full items-center justify-center gap-2 rounded-xl px-4 py-3 text-[14px] font-semibold transition',
                      plan.featured
