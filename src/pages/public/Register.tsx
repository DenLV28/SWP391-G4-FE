...
import { User, validateEmail, validatePhone, validateRequired } from '../../data/mockData';
      ...
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-slate-100 bg-white p-8 shadow-md">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <FormInput
            ...
            placeholder="29A-12345 hoặc 90B-123.45"
          />
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 border rounded-lg text-sm ${
                errors.vehicleType ? 'border-red-400' : 'border-slate-300'
              } focus:outline-none focus:ring-2 ${
                errors.vehicleType ? 'focus:ring-red-500' : 'focus:ring-blue-500'
              }`}
            >
